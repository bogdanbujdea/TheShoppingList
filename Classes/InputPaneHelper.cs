...
namespace TheShoppingList.Classes
{
    ...
    {
        private readonly Dictionary<UIElement, InputPaneShowingHandler> handlerMap;
        private InputPaneHidingHandler hidingHandlerDelegate;
        ...
        public void AddShowingHandler(UIElement element, InputPaneShowingHandler handler)
        {
            ...
            {
                throw new Exception("A handler is already registered!");
            }
            else
            {
