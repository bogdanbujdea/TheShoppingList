...
namespace TheShoppingList
{
    ...
    /// </summary>
    public sealed partial class ProductsPageGrid : LayoutAwarePage
    {
        public ProductsPageGrid()
        {
            InitializeComponent();
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            //var productsByCategories = ShoppingList.Products.GroupBy(x => x.Category)
        ...
        {
            //itemGridView_SelectionChanged_1(sender,null);
        }
